...
public class KLineActivity extends AppCompatActivity {
    ...
    private void setCpmbinedChartStyle() {
        combinedchart.setDrawBorders(true);//是否在折线图上添加边框
        combinedchart.setBorderWidth(1);
        combinedchart.setBorderColor(getResources().getColor(R.color.minute_grayLine));
        combinedchart.setDescription("");// 数据描述
        combinedchart.setDragEnabled(true);//是否可以拖拽
        combinedchart.setScaleYEnabled(true);// 是否可以缩放

        Legend combinedchartLegend = combinedchart.getLegend();// 设置比例图标示
    ...
    private void setBarChartStyle() {
        ...
        barChart.setScaleYEnabled(true);// 是否可以缩放

        Legend barChartLegend = barChart.getLegend();// 设置比例图标示
        barChartLegend.setEnabled(false);

        //BarYAxisFormatter  barYAxisFormatter=new BarYAxisFormatter();
        //bar x y轴
        xAxisBar = barChart.getXAxis();
        xAxisBar.setDrawLabels(true);//是否显示刻度标识
        xAxisBar.setDrawGridLines(false);//是否显示轴刻度网线
        xAxisBar.setDrawAxisLine(false);//是否显示边框
        ...
        axisLeftBar.setDrawGridLines(false);//是否显示轴刻度网线
        axisLeftBar.setDrawAxisLine(false);//是否显示边框
        axisLeftBar.setTextColor(getResources().getColor(R.color.minute_zhoutv));
        axisLeftBar.setDrawLabels(true);
        axisLeftBar.setSpaceTop(0);
        axisLeftBar.setShowOnlyMinMax(true);
        axisRightBar = barChart.getAxisRight();
        axisRightBar.setDrawLabels(true);//是否显示刻度标识
        axisRightBar.setDrawGridLines(false);//是否显示轴刻度网线
        axisRightBar.setDrawAxisLine(false);//是否显示边框
    ...
    private void setData(DataParse mData) {
        ...
        //设置成交量
        setBarChartData(barEntries, xVals);
        ...
        CandleData candleData = getCandleData(candleEntries, xVals);
 ...
 ****************************************************************************************/
     ...
     * @param xVals
     */
    private void setBarChartData(ArrayList<BarEntry> barEntries, ArrayList<String> xVals) {
     ...
     * @return
     */
    private CandleData getCandleData(ArrayList<CandleEntry> candleEntries, ArrayList<String> xVals) {
